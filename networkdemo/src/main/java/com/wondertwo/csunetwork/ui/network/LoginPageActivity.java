...
public class LoginPageActivity extends BaseNetworkActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        /*if(!TextUtils.isEmpty(BaseNetworkActivity.getSpUtil().getValue(NetworkConstant.SP_USER_NUMBER, ""))){
            tvSplashWelcome.setText(R.string.welcome_you + BaseNetworkActivity.getSpUtil().getValue(NetworkConstant.SP_USER_NUMBER, ""));
        }
        if (BaseNetworkActivity.getSpUtil().isFirstTimeStart()) {
            new AlertDialog.Builder(AppSplashActivity.this)
                    .setTitle(R.string.tip).setMessage(R.string.first_start_tip)
                    .setPositiveButton(R.string.goto_login_page, new DialogInterface.OnClickListener() {
                        @Override
